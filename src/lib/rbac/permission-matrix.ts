...
export const PERMISSION_ROUTE_MATRIX: readonly PermissionRouteRule[] = [
  ...
  {
    id: "api-topping-read-all",
    resourceKey: "api.pos.topping.read",
    description: "Read topping master data.",
    match: { mode: "prefix", value: "/api/pos/topping" },
    methods: READ_METHODS,
    allowedRoles: ALL_ROLES,
  },
  {
    id: "api-topping-write-admin-manager",
    resourceKey: "api.pos.topping.write",
    description: "Write topping master data.",
    match: { mode: "prefix", value: "/api/pos/topping" },
    methods: WRITE_METHODS,
    allowedRoles: ["Admin", "Manager"],
  },
  ...
  {
    id: "api-pos-tables-read-all",
    resourceKey: "api.pos.tables.read",
    description: "Read POS table and table QR data.",
    match: { mode: "prefix", value: "/api/pos/tables" },
    methods: READ_METHODS,
    allowedRoles: ALL_ROLES,
  },
  {
    id: "api-pos-tables-write-admin-manager",
    resourceKey: "api.pos.tables.write",
    description: "Write POS table master data and rotate table QR tokens.",
    match: { mode: "prefix", value: "/api/pos/tables" },
    methods: WRITE_METHODS,
    allowedRoles: ["Admin", "Manager"],
  },
