...
export const PAGE_PERMISSION_MAP: Array<{ prefix: string; requirement: PermissionRequirement }> = [
    ...
    { prefix: "/pos/topping/manager/add", requirement: { resourceKey: "topping.page", action: "create" } },
    { prefix: "/pos/topping/manager/edit", requirement: { resourceKey: "topping.page", action: "update" } },
    { prefix: "/pos/topping/manager", requirement: { resourceKey: "topping.page", action: "update" } },
    { prefix: "/pos/toppingGroup/manager/add", requirement: { resourceKey: "topping.page", action: "create" } },
    { prefix: "/pos/toppingGroup/manager/edit", requirement: { resourceKey: "topping.page", action: "update" } },
    { prefix: "/pos/toppingGroup/manager", requirement: { resourceKey: "topping.page", action: "update" } },
    { prefix: "/pos/toppingGroup", requirement: { resourceKey: "topping.page", action: "view" } },
