...
export const PageHeader = ({ isEdit, onBack, onDelete }: HeaderProps) => (
    <ManagePageHeader
        ...
        onBack={onBack}
        onDelete={onDelete}
        titleCreate="เพิ่มวิธีการชำระเงิน"
        titleEdit="แก้ไขวิธีการชำระเงิน"
    />
);
...
export const PaymentMethodPreview = ({ name, displayName }: PaymentMethodPreviewProps) => {
    ...
    } else if (lower.includes("promptpay")) {
            ...
            >
                ...
                <div style={{ position: "relative", zIndex: 2, flex: 1 }}>
                    ...
                    <div style={{ marginTop: 40 }}>
                        <div style={{ fontSize: 12, opacity: 0.7, marginBottom: 4 }}>Payment Method</div>
                        <div
                            style={{
                                fontSize: 24,
                                fontWeight: 700,
