...
export const ManagePageStyles = () => (
    <style>{`
        ...
        .manage-page .ant-input-affix-wrapper-focused {
            ...
            box-shadow: 0 0 0 3px rgba(19, 194, 194, 0.1) !important;
        }
        ...
        <div style={pageStyles.headerContent}>
            ...
            <div style={{ flex: 1 }}>
                ...
                <Title level={4} style={{ 
                    ...
                    {isEdit ? 'แก้ไขหน่วยสินค้า' : 'เพิ่มหน่วยสินค้า'}
                </Title>
            </div>
            {isEdit && onDelete && (
                <Button
...
export const UnitPreview = ({ displayName, unitName }: UnitPreviewProps) => (
    <div style={{
        display: 'flex',
        alignItems: 'center',
        gap: 14,
