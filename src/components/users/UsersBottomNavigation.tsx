...
const UsersBottomNavigation = () => {
    ...
    return (
        <div className="fixed bottom-6 left-0 right-0 mx-auto w-fit z-50">
            <div
                className="flex justify-center items-center h-[72px] px-6 py-2 bg-[#171717]/95 backdrop-blur-xl shadow-2xl border border-white/10 rounded-full min-w-[120px]"
