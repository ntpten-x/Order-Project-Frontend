...
export const createManagePageStyles = ({
    focusColor,
    focusShadow,
    switchGradient,
    extraCss = "",
    ...
    return { pageStyles, ManagePageStyles };
};

type ManageActionButtonsProps = {
    pageStyles: ReturnType<typeof createManagePageStyles>["pageStyles"];
    isEdit: boolean;
    loading: boolean;
    onCancel: () => void;
};

export const ManageActionButtons = ({
    pageStyles,
    isEdit,
    loading,
    onCancel,
}: ManageActionButtonsProps) => (
