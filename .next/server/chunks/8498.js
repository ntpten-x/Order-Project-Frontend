...
`},10985:(t,r,e)=>{var a;e.d(r,{c:()=>a}),function(t){t.Available="Available",t.Unavailable="Unavailable"}(a||(a={}))},95963:(t,r,e)=>{e.d(r,{EO:()=>w,Gs:()=>d,HL:()=>F,M9:()=>k,Nz:()=>h,OY:()=>n,Rr:()=>f,Wl:()=>o,d$:()=>v,d7:()=>p,iN:()=>s,jN:()=>x,ku:()=>u,mz:()=>m,qO:()=>l,xG:()=>g,yj:()=>y,zP:()=>c,zf:()=>B});var a=e(13976),i=e(10985);let o=t=>{if(t.status===i.c.Available)return`/pos/channels/dine-in/${t.id}`;let r=t.active_order_id||t.active_order?.id,e=t.active_order_status||t.active_order?.status;return r?e===a.i.WaitingForPayment?`/pos/items/payment/${r}`:`/pos/orders/${r}`:`/pos/channels/dine-in/${t.id}`},n=t=>{switch(t){case a.i.Pending:return"orange";case a.i.Cooking:return"blue";case a.i.Served:return"green";case a.i.Paid:return"cyan";case a.i.Cancelled:return"red";case a.i.WaitingForPayment:return"gold";default:return"default"}},p=(t,r)=>{switch(t){case a.i.Pending:return"กำลังดำเนินการ";case a.i.Cooking:return"กำลังปรุง";case a.i.Served:if("TakeAway"===r||"Delivery"===r)return"ทำแล้ว";return"เสิร์ฟแล้ว";case a.i.Paid:return"ชำระเงินแล้ว";case a.i.Completed:return"สำเร็จ";case a.i.Cancelled:return"ยกเลิก";case a.i.WaitingForPayment:return"รอชำระเงิน";default:return t}},d=t=>{switch(t){case"DineIn":return"#722ed1";case"TakeAway":return"#fa8c16";case"Delivery":return"#eb2f96";default:return"#1890ff"}},m=t=>{switch(t){case"DineIn":return"ทานที่ร้าน";case"TakeAway":return"สั่งกลับบ้าน";case"Delivery":return"เดลิเวอรี่";default:return t}},l=t=>"DineIn"===t?"เสิร์ฟ":"ทำแล้ว",s=t=>"Delivery"===t?"จัดออเดอร์เสร็จแล้วพร้อมส่งให้ไรเดอร์":"DineIn"===t?"ยืนยันเสิร์ฟพร้อมชำระเงิน":"ยืนยันทำแล้วพร้อมชำระเงิน",c=t=>"DineIn"===t?"เสิร์ฟอาหารแล้ว":"ปรุงเสร็จแล้ว",g=t=>{let r="string"==typeof t?parseFloat(t):t;return`฿${Number(r).toLocaleString("th-TH",{minimumFractionDigits:0,maximumFractionDigits:2})}`},x=t=>"DineIn"===t.order_type?t.table?.table_name||"ไม่ระบุโต๊ะ":"Delivery"===t.order_type?t.delivery_code||t.delivery?.delivery_name||"ไม่ระบุข้อมูล":"TakeAway"===t.order_type?t.order_no||"ไม่ระบุเลขที่":t.order_no||"N/A",h=t=>(t??[]).filter(t=>t.status!==a.i.Cancelled),b=t=>(t??[]).reduce((t,r)=>t+(Number(r.extra_price)||0),0),u=(t,r,e)=>((Number(t)||0)+b(e))*r,f=t=>h(t).reduce((t,r)=>{let e=r.product?.category?.display_name||"ไม่ระบุหมวด";return t[e]=(t[e]||0)+(r.quantity||0),t},{}),y=t=>h(t).reduce((t,r)=>t+Number(r.total_price||0),0),w=t=>"DineIn"===t.order_type?"/pos/channels/dine-in":"TakeAway"===t.order_type?"/pos/channels/takeaway":"Delivery"===t.order_type?"/pos/channels/delivery":"/pos/orders",F=t=>`/pos/orders/${t}`,k=t=>t.status===a.i.WaitingForPayment?t.order_type===a.m.Delivery?`/pos/items/delivery/${t.id}`:`/pos/items/payment/${t.id}`:`/pos/orders/${t.id}`,v=t=>t===a.m.Delivery?"/pos/channels/delivery":t===a.m.TakeAway?"/pos/channels/takeaway":t===a.m.DineIn?"/pos/channels/dine-in":"/pos/channels",B=(t,r,e,i)=>({order_no:i.orderNo||`ORD-${Date.now()}`,order_type:r,sub_total:e.subTotal,discount_amount:e.discountAmount,vat:0,total_amount:e.totalAmount,received_amount:0,change_amount:0,status:a.i.Pending,discount_id:i.discountId||null,payment_method_id:null,table_id:i.tableId||null,delivery_id:i.deliveryId||null,delivery_code:i.deliveryCode||null,items:t.map(t=>{let r=Number(t.product.price),e=(r+(t.details||[]).reduce((t,r)=>t+Number(r.extra_price),0))*t.quantity;return{product_id:t.product.id,quantity:t.quantity,price:r,total_price:e,discount_amount:0,notes:t.notes||"",status:a.i.Cooking,details:t.details||[]}})})}};