...
`},35905:(t,e,r)=>{"use strict";var a;r.d(e,{b:()=>a}),function(t){t.Pending="Pending",t.Success="Success",t.Failed="Failed"}(a||(a={}))},41947:(t,e,r)=>{"use strict";r.d(e,{S:()=>a});let a=t=>{if(!t?.length)return[];let e=new Map;for(let r of t){let t=r.details?.length?JSON.stringify([...r.details].sort((t,e)=>t.detail_name.localeCompare(e.detail_name))):"[]",a=(r.notes??"").trim(),o=String(r.status??""),i=r.product?.id??r.product_id??"unknown",n=`${i}|${t}|${a}|${o}`,s=e.get(n);if(s){s.quantity+=Number(r.quantity),s.total_price+=Number(r.total_price??0),s.originalItems.push(r);continue}let d={...r,id:String(r?.id??n),quantity:Number(r.quantity),total_price:Number(r.total_price??0),originalItems:[r]};e.set(n,d)}return Array.from(e.values())}},27851:(t,e,r)=>{"use strict";r.d(e,{Od:()=>i,T_:()=>m,VX:()=>n,cc:()=>o,hs:()=>a,si:()=>s,wv:()=>d});let a=(t,e=0)=>{if(!t)return{subtotal:0,discount:0,vat:0,total:0,change:0};let r=Number(t.sub_total||0),a=Number(t.discount_amount||0),o=Number(t.vat||0),i=Number(t.total_amount||0);return{subtotal:r,discount:a,vat:o,total:i,change:Math.max(0,e-i)}},o=(t="",e="")=>{let r=t.toLowerCase(),a=e.toLowerCase();return r.includes("cash")||a.includes("สด")},i=(t="",e="")=>{let r=t.toLowerCase(),a=e.toLowerCase();return r.includes("qr")||r.includes("prompt")||a.includes("qr")||a.includes("พร้อมเพย์")},n=(t="",e="",r=null)=>!i(t,e)||!!r?.promptpay_number,s=[20,50,100,500,1e3],d=()=>"/pos/channels",m=t=>`/pos/orders/${t}`},54354:(t,e,r)=>{"use strict";function a(t,e,r,a=t=>t.id,o=()=>!0){}function o({socket:t,events:e=[],onRefresh:r,intervalMs:a,enabled:o=!0,debounceMs:i}){}r.d(e,{D:()=>o,v:()=>a}),r(17577)}};